 ...
 * 目录原文。目录语义、曲号、版本、艺人分隔符和繁简转换全部由插件处理。核心不得传递媒体路径、时长、
 * ISRC、关键词、代理或任何凭据；`taskIdentity` 仅是核心任务与插件审计记录之间的不透明关联键，插件
...
final readonly class MetadataScrapeCompletionRequest
{
    ...
    public static function fromMetadata(string $title, array $artists, ?string $albumTitle = null, ?array $albumArtists = null,
        ?string $taskIdentity = null): self
    {
        return new self($title, $artists, $albumTitle, $albumArtists, self::MODE_METADATA, taskIdentity: $taskIdentity);
    }
